...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for eff3 in node_a2.action.effect_rem:
            for eff4 in node_a1.action.effect_add:
                if eff3==eff4:
                    return True
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for eff in node_a1.action.effect_rem:
            for pre in node_a2.action.precond_pos:
                if eff==pre:
                    return True
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for par1 in node_s1.parents:
            for par2 in node_s2.parents:
                if not par1.is_mutex(par2):
                    return False
        return True
